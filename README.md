...
A global density map was created to visually highlight regions experiencing the highest density of seismic activity. Hexagonal points are used to represent the number of earthquakes in a location. Based on the cyan hexagonal points, many earthquakes in the past 24 hours are occurring in the western region of the United States. This geological location sits on the edge of active tectonic plates, a boundary that features the San Andreas Fault, where the network of cracks results in numerous earthquakes.
